...
@app.route('/post_page')
def post_page():
    return render_template('post_page.html')  # Replace with actual post page template

@app.route('/comments_page')
def comments_page():
    return render_template('comments_page.html')  # Replace with actual comments page template
